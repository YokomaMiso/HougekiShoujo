...
public class NanamiAnimData : CharacterAnimData
{
    ...
    public override RuntimeAnimatorController GetIdleAnim(CANON_STATE _state = CANON_STATE.EMPTY)
    {
        if (_state == CANON_STATE.EMPTY) { return idle2AnimationData; }
        else { return idleAnimationData; }
    }
    public override RuntimeAnimatorController GetRunAnim(int _num, CANON_STATE _state = CANON_STATE.EMPTY)
    {
